...
<table> 
  <tr>
   ...
   <tr>
    ...
    <tr>
      <th>역할<br>및<br>업무</th>
      <th>발표<br>관리자<br>코드 구현<br>화면설계<br>데이터 생성<br>DB 설계</th>
      <th>교사(전체)<br>코드 구현<br>화면설계<br>소스취합<br>데이터 생성<br>DB 설계</th>
      <th>관리자<br코드 구현<br>화면설계<br>데이터 생성<br>DB 설계</th>
      <th>팀장<br>발표 보조<br>관리자<br>코드 구현<br>화면설계<br>데이터 생성<br>DB 설계</th>
      <th>교육생(전체)<br>코드 구현<br>관리자<br>코드 구현<br>화면설계<br>데이터 생성<br>DB 설계</th>
